...
public class SiedlerGame {
  ...
  private boolean hasRoomToBuildSettlement() {
    ...
    for (Building building : siedlerBoard.getCorners()) {
      if (building.getClass() == Settlement.class
          && building.getFaction() == getCurrentPlayerFaction()) {
        list.add(building);
      }
    }
   ...
   * for (Building building : siedlerBoard.getCorners()) { if
   * (building.getClass() == Road.class && building.getFaction() ==
   * getCurrentPlayerFaction()) { list.add(building); } } if (list.size() <
  ...
  public boolean buildCity(Point position) { // TODO: testing
    ...
    if (isBuilduingFaction(position) && isSettlement
        && hasEnoughToBuild(Structure.CITY.getCosts())) {
  ...
  public boolean buildRoad(Point roadStart, Point roadEnd) {
    if (isRoadPositionValid(roadStart, roadEnd)
        && hasEnoughToBuild(Structure.ROAD.getCosts())) {
